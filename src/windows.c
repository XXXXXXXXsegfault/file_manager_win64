...
asm "pop %rbp"
asm "ret"
long GetClientRect(void *hwnd,void *ret);
asm "@GetClientRect"
asm "push %rbp"
asm "mov %rsp,%rbp"
asm "and $0xf0,%spl"
...
asm "mov 24(%rbp),%rdx"
asm "sub $32,%rsp"
asm ".dllcall \"user32.dll\" \"GetClientRect\""
asm "add $32,%rsp"
asm "pop %r11"
asm "pop %r10"
asm "pop %r9"
...
int CreateProcessA(char *iname,char *cmd,void *pattr,void *tattr,int ihandles,int flags,char *env,char *dir,void *startinfo,void *procinfo);
asm "@CreateProcessA"
asm "push %rbp"
asm "mov %rsp,%rbp"
asm "and $0xf0,%spl"
...
asm "pushq 48(%rbp)"
asm "sub $32,%rsp"
asm ".dllcall \"kernel32.dll\" \"CreateProcessA\""
asm "add $80,%rsp"
asm "pop %r11"
asm "pop %r10"
asm "pop %r9"
...
asm "pop %rbp"
asm "ret"
void exec_program(char *iname,char *cmd)
{
	static long buf[13];
	void *pinfo[3];
	buf[0]=104;
	if(CreateProcessA(iname,cmd,0,0,0,0,0,0,buf,pinfo))
	{
		CloseHandle(pinfo[0]);
		CloseHandle(pinfo[1]);
	}
...
asm "mov 24(%rbp),%rdx"
asm "sub $32,%rsp"
asm ".dllcall \"user32.dll\" \"ClientToScreen\""
asm "add $32,%rsp"
asm "pop %r11"
asm "pop %r10"
asm "pop %r9"
